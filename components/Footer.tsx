      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link href="/faq" className="hover:text-cyan-500 transition-colors">FAQ</Link></li>
              <li><Link href="/contact" className="hover:text-cyan-500 transition-colors">Contact</Link></li>
              <li><Link href="/blog" className="hover:text-cyan-500 transition-colors">Fishing Reports & Tips</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-navy-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm">
            &copy; {new Date().getFullYear()} Traverse City Bass Destination Charters. All rights reserved.
          </p>
