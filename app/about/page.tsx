...
export const metadata: Metadata = {
  ...
  description: 'Meet Captain Butch Derickson, your licensed USCG fishing guide with 20+ years experience on Grand Traverse Bay. Learn about our boat and fishing expertise.',
  openGraph: {
    ...
    images: ['/images/captain-butch.jpg'],
  },
};
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                After retiring as a mechanical engineer in the power industry, I turned my lifelong passion for bass fishing into TC Bass Destination Charters. With over 20 years on these waters, I know every contour, ledge, and hiding spot in Grand Traverse Bay and the surrounding inland lakes.
              </p>
